...
# Ghi chú:
### Cần tự tìm hiểu thêm về pm2 để lần sau chạy lại dịch vụ
lần sau cần chạy lại dịch vụ thì không cần phải làm các bước 1 2 3 4 5 nữa. nếu đổi pass ngân hàng thì vào sửa phải config thôi